...
%   assumes the representational vocabulary of Volume I (Zero to Bit) and the hardware model of Volume II (Silicon Horizon). If compiled as a standalone book, replace \part{} below
