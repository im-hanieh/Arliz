...
\begin{itemize}
	\item \textbf{Volume I --- BIT GENESIS:} How information is encoded at all, from semiconductor switching and voltage levels through bits, numbers, characters, and the raw encodings everything else is built from.
